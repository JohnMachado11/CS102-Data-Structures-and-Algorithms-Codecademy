...
# https://www.youtube.com/watch?v=P9cU0klfZCU
...
def get_start():
    ...
    if start_point_letter in landmark_choices:
        ...
        print("Sorry, that's not a landmark we have on data. Let's try this again...")
        return get_start()
...
def get_active_stations():
    ...
    for station_under_construction in stations_under_construction:
        for current_station, neighboring_station in vc_metro.items():
            ...
            # takes all of the stations in (updated_metro[current_stations]) and removes
            # any of the stations that are under construction (station_under_construction)
