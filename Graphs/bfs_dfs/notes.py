...
# breadth-first search, known as BFS broadens its search from the point of origin to 
# an ever-expanding circle of neighboring vertices

# Computer Science Basics Algorithms: Introduction to Graph Search Algorithms
# https://www.youtube.com/watch?v=swpIQgPoCWs

# Computer Science Basics Algorithms: How Depth First Search Works
# https://www.youtube.com/watch?v=0_ZzqX5bpyA

# Computer Science Basics Algorithms: How Breadth First Search Works
...
# .There are three common traversal orders which you can apply with DFS to generate a list of all values in a graph: pre-order,
